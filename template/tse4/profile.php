  ...
  <div class="leftcolumn"> <!-- Vasen columni jossa kortti jonka sisällä postaukset näkyvät-->
    <div class="card" id="postcard">
      ...
      <div class="center-posts"><!--Blogin postaukset laatikoissa ja napit-->
        ...
        <p>Täällä profiilin muokkaus asetukset </p>
        
          <h3> Username: <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b> </h3> 
       
        <p>Password: ************     <!-- salasanan vaihto  ja PROFIILISS MENOSSA   :) -->
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <input type="file"  name="fileToUpload" id="fileToUpload" accept="image/png, image/jpeg">  <!-- Profiilikuvan tiedoston valinta ja tallennuspainike vain kuvat hyväksytään --> 
