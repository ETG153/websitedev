            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="#" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Comment</a>
                    </div>
                    <?php
                    // Include config file
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo '<a href="readcomment.php?id='. $row['comment_id'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="update_posts.php?id='. $row['comment_id'] .'" class="mr-3" title="Update comment" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
