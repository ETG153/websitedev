...
<div class="center center-join">
   ...
   <label for="e-mail">e-mail</label>  
    <input type="text" id="email" class=" form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?> " name="email" placeholder="e-mail"><!-- Muista sähköpostin php osuus yläpuolelle -->
